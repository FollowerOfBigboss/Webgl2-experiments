...
function main() {
	...
	function render(now)
	{
		...
		glMatrix.mat4.rotate(model, model, glMatrix.glMatrix.toRadian(-55.0), glMatrix.vec3.fromValues(1.0, 0.0, 0.0));
		glMatrix.mat4.translate(view, view, glMatrix.vec3.fromValues(0.0, 0.0, -3.0));
		glMatrix.mat4.perspective(projection, glMatrix.glMatrix.toRadian(45.0), 640/480, 0.1, 100.0);
