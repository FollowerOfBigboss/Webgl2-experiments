...
function main() {
	...
	const pointLightColors = [
		glMatrix.vec3.fromValues(1.0, 0.6, 0.0),
		glMatrix.vec3.fromValues(1.0, 0.0, 0.0),
		glMatrix.vec3.fromValues(1.0, 1.0, 0.0),
		glMatrix.vec3.fromValues(0.2, 0.2, 1.0)
	];
	...
	function render(now)
	{
		...
		lightingShader.setVec3("dirLight.ambient", 0.3, 0.24, 0.14);
		lightingShader.setVec3("dirLight.diffuse", 0.7, 0.42, 0.26);
		...
		lightingShader.setVec3("spotLight.diffuse", 0.8, 0.8, 0.0);
		lightingShader.setVec3("spotLight.specular", 0.8, 0.8, 0.0);
		lightingShader.setFloat("spotLight.constant", 1.0);
		lightingShader.setFloat("spotLight.linear", 0.09);
		lightingShader.setFloat("spotLight.quadratic", 0.032);
		lightingShader.setFloat("spotLight.cutOff", Math.cos(glMatrix.glMatrix.toRadian(12.5)));
		lightingShader.setFloat("spotLight.outerCutOff", Math.cos(glMatrix.glMatrix.toRadian(13.0)));
