...
function main() {
	...
	const pointLightColors = [
		glMatrix.vec3.fromValues(0.2, 0.2, 0.6),
		glMatrix.vec3.fromValues(0.3, 0.3, 0.7),
		glMatrix.vec3.fromValues(0.0, 0.0, 0.3),
	...
	function render(now)
	{
		...
		lightingShader.setVec3("dirLight.ambient", 0.05, 0.05, 0.1);
		lightingShader.setVec3("dirLight.diffuse", 0.2, 0.2, 0.7);
		lightingShader.setVec3("dirLight.specular", 0.7, 0.7, 0.7);
		// point light 1
		...
		lightingShader.setFloat("spotLight.outerCutOff", Math.cos(glMatrix.glMatrix.toRadian(12.5)));
