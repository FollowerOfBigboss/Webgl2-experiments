...
function main() {
	...
	const pointLightColors = [
		glMatrix.vec3.fromValues(0.4, 0.7, 0.1),
		glMatrix.vec3.fromValues(0.4, 0.7, 0.1),
		glMatrix.vec3.fromValues(0.4, 0.7, 0.1),
		glMatrix.vec3.fromValues(0.4, 0.7, 0.1)
	];
	...
	function render(now)
	{
		...
		lightingShader.setVec3("spotLight.diffuse", 0.0, 1.0, 0.0);
		lightingShader.setVec3("spotLight.specular", 0.0, 1.0, 0.0);
		...
		lightingShader.setFloat("spotLight.cutOff", Math.cos(glMatrix.glMatrix.toRadian(7.0)));
		lightingShader.setFloat("spotLight.outerCutOff", Math.cos(glMatrix.glMatrix.toRadian(10.0)));
